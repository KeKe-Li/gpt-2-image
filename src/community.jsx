...
const communityCopy = {
  zh: {
    ...
    retry: '重试',
    support: '公众号与人工支持',
    supportText: '关注公众号「keke」，或在微信搜索「keke」。支付、入群、退款或使用问题都可以通过公众号留言联系；退款经人工审核后原路退回。',
    supportQrAlt: 'keke微信公众号二维码与微信搜索提示',
  ...
  en: {
    ...
    supportText: 'Follow the WeChat official account keke, or search keke in WeChat. Message the account for payment, access, refund, or product questions.',
    supportQrAlt: 'QR code and WeChat search card for the keke official account',
